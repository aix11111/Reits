...
报告的差异情况说明」段落，例如 180201 2022 年报：
...
def parse_annual_completion(pdf_path: str) -> dict:
    """解析年报 PDF 的「可供分配完成度」段落，返回 _parse_completion_text 同构字典。"""
    return _parse_completion_text(_find_completion_section(extract_text(pdf_path)))
